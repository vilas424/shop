<?php
    ...
    if(isset($_POST['cont']))
    { 
         header("location: ../php/sellProduct.php");
    }
    ...
    { 
        ...
        header("location: ../html/addCustomer.html");
    }
    ...
    { 
        ...
        if(mysql_num_rows($result)>0)
        {
            ...
            {        
                ...
                mysql_query($query2);
                header("location: ../html/product_DryFruits.html");
            }
        }
    }
    ...
    { 
        ...
        if(mysql_num_rows($result)>0)
        {
            ...
            {        
                ...
                $query2="insert into ORDER_INFO values('$res1','$res2','$res3','$res4','$res5','$res6');";
                mysql_query($query2);
                header("location: ../html/product_Cereals.html");
            }
        }
    }
    ...
    { 
        ...
        if(mysql_num_rows($result)>0)
        {
            ...
            {        
                ...
                $query2="insert into ORDER_INFO values('$res1','$res2','$res3','$res4','$res5','$res6');";
                mysql_query($query2);
                header("location: ../html/product_Baby.html");
            }
        }
    }
    ...
    { 
        ...
        if(mysql_num_rows($result)>0)
        {
            ...
            {        
                ...
                $query2="insert into ORDER_INFO values('$res1','$res2','$res3','$res4','$res5','$res6');";
                mysql_query($query2);
                header("location: ../html/product_Packets.html");
            }
        }
    }
    ...
    { 
        ...
        if(mysql_num_rows($result)>0)
        {
            ...
            {        
                ...
                $query2="insert into ORDER_INFO values('$res1','$res2','$res3','$res4','$res5','$res6');";
                mysql_query($query2);
                header("location: ../html/product_Home.html");
            }
        }
    }
    ...
    { 
        ...
        if(mysql_num_rows($result)>0)
        {
            ...
            {        
                ...
                $query2="insert into ORDER_INFO values('$res1','$res2','$res3','$res4','$res5','$res6');";
                mysql_query($query2);
                header("location: ../html/product_Dairy.html");
            }
        }
    }
    ...
    { 
        ...
        if(mysql_num_rows($result)>0)
        {
            ...
            {        
                ...
                $query2="insert into ORDER_INFO values('$res1','$res2','$res3','$res4','$res5','$res6');";
                mysql_query($query2);
                header("location: ../html/product_Snacks.html");
            }
        }
    }
