...
if (str.length==0)
  {
  document.getElementById("Wlivesearch").innerHTML="";
  document.getElementById("Wlivesearch").style.border="0px";
  return;
  }
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("Wlivesearch").innerHTML=xmlhttp.responseText;
    document.getElementById("Wlivesearch").style.border="1px solid #A5ACB2";
    }
  }
xmlhttp.open("GET","Wlivesearch.php?q="+str,true);
xmlhttp.send();
}
</script>
...
<body>
        <ul id="menu-bar">
            <li class="active"><a href="../html/workercontrol.html">Home</a></li>
            <li><a href="#">About</a>
                <ul>
                    <li><a href="#">Shop</a></li>
        ...
        <div id="wrapper">    
			...
			<div id="slider_container_2">
				<div id="SliderName_2" class="SliderName_2">
					<a href="../html/Wproduct_BodyCare.html"><img src="../img/10.jpg" width="600" height="350" title="first" /></a>
					<div class="SliderName_2Description">Garnier Color <strong>FREE</strong>Garnier Face Wash</div>
					<a href="../html/Wproduct_Snacks.html"><img src="../img/11.jpg" width="600" height="350" title="second" /></a>
					<div class="SliderName_2Description">Maggi Noodles <strong>Chicken</strong></div>
					<a href="../html/Wproduct_Snacks.html"><img src="../img/12.jpg" width="600" height="350" title="third" /></a>
					<div class="SliderName_2Description">Bingo Chips <strong>Potato</strong></div>
					<a href="../html/Wproduct_Dairy.html"><img src="../img/13.jpg" width="600" height="350" title="fourth" /></a>
        ...
        <ul id="menu">
            ...
            <div class="dropdown_4columns">
                ...
                <div class="col_1">
                    ...
                    <h3>Groceries</h3>
                    <ul>
                        <li><a href="../html/Wproduct_Cereals.html">Cereals & Pulses</a></li>
                        <li><a href="../html/Wproduct_DryFruits.html">Dry Fruits</a></li>
                    </ul>   
                ...
                <div class="col_1">
                    ...
                    <h3>Personal Care</h3>
                    <ul>
                        <li><a href="../html/Wproduct_BodyCare.html">Body Care</a></li>
                        <li><a href="../html/Wproduct_Baby.html">Baby & Child Care</a></li>
                    </ul>   
                ...
                <div class="col_1">
                    ...
                    <h3>Home care</h3>
                    <ul>
                        <li><a href="../html/Wproduct_Home.html">Cleaners</a></li>
                        <li><a href="../html/Wproduct_Packets.html">Household Needs</a></li>
                    </ul>   
                ...
                <div class="col_1">
                    ...
                    <ul>
                        <li><a href="../html/Wproduct_Dairy.html">Diary Products</a></li>
                        <li><a href="../html/Wproduct_Snacks.html">Snacks</a></li>
                    </ul>   
